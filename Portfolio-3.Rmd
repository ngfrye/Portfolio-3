...
The dates are characters because they're typed in a bunch of different ways, with some ranges, some "circa"'s, etc. Many of them are in normal year fomat, though, so I'd like to try to coerce the column into being numeric so I can see the distribution of those years. 
...
ggplot(data = npg_art, 
  ...
  labs(title = "Year Distribution of Art Pieces", 
       x = "Year",
       y = "Number of pieces") 
```
